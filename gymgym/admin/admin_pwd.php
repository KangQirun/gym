...
document.form1.submit();
  ...
  <table width="97%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableBorder">
	<form action="admin_pwd1.php?id=<?php echo $data[id]?>" method="post" name="form1" onsubmit="check_form();return false;">
    <tr>
    ...
    <tr>
      ...
      <td width="84%" colspan="2" class="table"><input name="Username" type="text" id="UserName3" value="<?php echo $data[admin_name]?>">
