...
<tr onmouseover=this.style.backgroundColor="#F2F2F2" onmouseout=this.style.backgroundColor=""  bgcolor="#FFFFFF">
    ...
    <td>&nbsp;<div align="center"><?php   echo $rs["admin_name"]; ?></div></td>

    <td><div align="center">
	<a href="admin_pwd.php?id=<?php   echo $rs[id]; ?>" >修改</a>

	<a href="admin_del.php?id=<?php   echo $rs[id]; ?>" onclick="{if(confirm('您确定要删除此住户吗?')){return true;}return false;}">删除</a></div></td>
  </tr>
  <?php
}
		?>